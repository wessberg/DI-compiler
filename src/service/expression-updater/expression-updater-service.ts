...
export class ExpressionUpdaterService implements IExpressionUpdaterService {
	 ...
	 */
	private updateRegisterTransientExpression (container: IContainerService, {expression, typeName, implementationName}: IDIRegisterExpression): void {
		...
		const stringifiedOptions = `{identifier: ${typeStringified}, implementation: ${implementationStringified}}`;
